export class Collision {
    ...
    // Событие вызываемое при первом пересчении колизии
    collideAction(instigator) {
        this.drawable.collideAction(instigator);
    }

    // Проверяет пересечения с другой колизией
    // Пересечение считается только между кругом и прямоугольником
    // Input Collision
    // Output Boolean
    collide(collision) {
    ...
    // Логика проверки пересечения двух колизий
